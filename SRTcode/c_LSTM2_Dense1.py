...
setproctitle.setproctitle('c_LSTM2_Dense1@linziqian')  #from V1707
...
history=c_cl.fit(myX_train[0],Y_train,nb_epoch=1000, verbose=1, callbacks=[model_checkpoint], batch_size=batch_size,validation_data=(myX_test[0], Y_test))
